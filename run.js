  ...
  if (args[i][0] === '-') {
      switch (args[i]) {
        ...
        case '--help':
          ...
          console.log('-t, --test         no runing only show process structure')
          console.log('-s, --sequential   following cmds will be run in sequenz')
          ...
          console.log('-f, --first        only in parallel block: close all sibling processes after first exits (succes/error)')
